 ...
 * Request body example: { "warehouseId": 1, "deliveryIds": [1,2,3], "optimizer": "CLARKE" }
 */
public class TourController implements Controller {
    ...
    public TourController(DeliveryRepository deliveryRepository, WarehouseRepository warehouseRepository, TourService tourService) {
    ...
    public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            if (req.warehouseId != null) {
                ...
                if (wOpt.isPresent()) warehouse = wOpt.get();
            }
            ...
            for (Delivery d : optimized) dtos.add(DeliveryMapper.toDto(d));
