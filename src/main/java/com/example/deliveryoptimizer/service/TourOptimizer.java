 ...
 * Implementations should compute an ordered list of deliveries representing an
 * optimal tour
...
public interface TourOptimizer {
    ...
    /**
     * Calculate an (optimal or heuristic) route for the given deliveries and
     * warehouse.
     *
     * @param deliveries list of deliveries to include in the tour (may be unsorted)
     * @param warehouse  the warehouse / depot used as origin (and possibly
     *                   destination)
